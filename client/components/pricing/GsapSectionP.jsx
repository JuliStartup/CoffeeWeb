  ...
  return (
    <div
      ...
      className={`problem-item w-[168px] bg-white rounded-[16px] px-[20px] pb-[16px] pt-[34px]
                 flex flex-col items-center justify-center gap-[32px] bg-[#fff]
...
const GsapSection = () => {
  return (
    <div className="relative w-full h-auto pt-24 pb-24 md:pt-32 md:pb-32 xl:pt-40 xl:pb-40 py-[90px] flex flex-col items-center justify-center bg-gradient-to-b from-[#f9f9fb] to-[#faf9fa] gap-[50px]">
