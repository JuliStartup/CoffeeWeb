			...
			<div className="overflow-hidden bg-[--beige] py-2 w-full flex flex-wrap lg:flex-nowrap justify-center gap-4">
				{cardItems.map((item, index) => (
					<div
						...
						className={`cursor-pointer bg-[--card-bg] bg-opacity-10 p-0 rounded-xl shadow-md text-center flex flex-col items-center justify-center transition-transform duration-300 hover:scale-105 flex-grow basis-40 max-w-xs lg:h-16 ${
