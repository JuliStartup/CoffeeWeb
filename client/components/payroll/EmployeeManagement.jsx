        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-0 relative z-10 w-[100%] md:w-[70%] gap-[15px] md:gap-[0]">
          <div className="text-center flex items-center justify-start md:justify-center gap-[10px] md:gap-0 md:flex-col">
            ...
            >
              ...
              <div className="absolute inset-0 rounded-full border-2 border-[--purple] opacity-0 animate-ping-slow" />
            </div>
          ...
          <div className="text-center flex items-center justify-start md:justify-center gap-[10px] md:gap-0 md:flex-col">
            ...
            >
              ...
              <div className="absolute inset-0 rounded-full border-2 border-[--purple] opacity-0 animate-ping-slow animation-delay-300" />
            </div>
            <h3 className="text-lg font-semibold bg-white p-4 text-gray-800">
              Ongoing
            </h3>
          ...
          <div className="text-center flex items-center justify-start md:justify-center gap-[10px] md:gap-0 md:flex-col">
            ...
            >
              ...
              <div className="absolute inset-0 rounded-full border-2 border-[--purple] opacity-0 animate-ping-slow animation-delay-600" />
            </div>
            <h3 className="text-lg font-semibold bg-white p-4 text-gray-800">
              Offboarding
            </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 relative z-10 mt-[40px] xl:mt-0">
          ...
          >
            <div className="flex items-center mb-4">
              <div className="w-10 h-10 bg-[--purple] shadow-lg rounded flex items-center justify-center mr-3">
            ...
            <a
              href="#"
              className="text-[--purple] hover:underline mt-4 inline-block text-sm font-medium"
            >
              Learn more
            </a>
          </div>
