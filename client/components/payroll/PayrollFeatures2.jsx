...
function FeatureItem({ title, description }) {
	return (
		<div className="flex flex-col lg:flex-row items-start gap-4">
			<div className="w-[90%] lg:w-36 p-4 h-14 lg:h-28 bg-[--beige] flex items-center justify-center shrink-0 rounded">
				<span className="text-[1.1rem] text-white lg:text-xl font-medium text-center">
					{title}
				</span>
			</div>
			<div className="space-y-2">
				<p className="text-[1rem] lg:text-lg text-gray-700 font-twk">
					{description}
				</p>
			</div>
		</div>
